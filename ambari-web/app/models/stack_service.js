...
App.StackService.configCategories = function () {
  ...
  switch (this.get('serviceName')) {
    case 'HDFS':
      serviceConfigCategories.pushObjects([
        App.ServiceConfigCategory.create({ name: 'NAMENODE', displayName: '名称节点', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'SECONDARY_NAMENODE', displayName: '第二名称节点', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'DATANODE', displayName: '数据节点', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'General', displayName: '一般'}),
        App.ServiceConfigCategory.create({ name: 'NFS_GATEWAY', displayName: 'NFS 网关', showHost: true})
      ]);
      break;
    case 'GLUSTERFS':
      serviceConfigCategories.pushObjects([
    ...
    case 'YARN':
      serviceConfigCategories.pushObjects([
        App.ServiceConfigCategory.create({ name: 'RESOURCEMANAGER', displayName: '资源管理', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'NODEMANAGER', displayName: '节点管理', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'APP_TIMELINE_SERVER', displayName: '应用 Timeline 服务', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'General', displayName: '一般'}),
        App.ServiceConfigCategory.create({ name: 'FaultTolerance', displayName: '容错'}),
        App.ServiceConfigCategory.create({ name: 'Isolation', displayName: '隔离'}),
        App.ServiceConfigCategory.create({ name: 'CapacityScheduler', displayName: '调度', siteFileName: 'capacity-scheduler.xml'})
      ]);
      break;
    case 'MAPREDUCE2':
      serviceConfigCategories.pushObjects([
        App.ServiceConfigCategory.create({ name: 'HISTORYSERVER', displayName: '历史服务', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'General', displayName: '一般'})
      ]);
      break;
    case 'HIVE':
      serviceConfigCategories.pushObjects([
        App.ServiceConfigCategory.create({ name: 'HIVE_METASTORE', displayName: 'Hive 元数据', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'WEBHCAT_SERVER', displayName: 'WebHCat 服务', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'General', displayName: '一般'}),
        App.ServiceConfigCategory.create({ name: 'Performance', displayName: '性能'}),
        App.ServiceConfigCategory.create({ name: 'HIVE_SERVER2', displayName: 'Hive Server2'}),
        App.ServiceConfigCategory.create({ name: 'HIVE_CLIENT', displayName: 'Hive 客户端'})
      ]);
      break;
    case 'HBASE':
      serviceConfigCategories.pushObjects([
    ...
    case 'ZOOKEEPER':
      serviceConfigCategories.pushObjects([
        App.ServiceConfigCategory.create({ name: 'ZOOKEEPER_SERVER', displayName: 'ZooKeeper 服务', showHost: true})
      ]);
      break;
    case 'OOZIE':
      serviceConfigCategories.pushObjects([
        App.ServiceConfigCategory.create({ name: 'OOZIE_SERVER', displayName: 'Oozie 服务', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'Falcon - Oozie integration', displayName: 'Falcon - Oozie 集成'})
      ]);
      break;
    case 'FALCON':
      serviceConfigCategories.pushObjects([
        App.ServiceConfigCategory.create({ name: 'FALCON_SERVER', displayName: 'Falcon 服务', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'Falcon - Oozie integration', displayName: 'Falcon - Oozie 集成'}),
        App.ServiceConfigCategory.create({ name: 'FalconStartupSite', displayName: 'Falcon 启动属性'}),
        App.ServiceConfigCategory.create({ name: 'FalconRuntimeSite', displayName: 'Falcon 运行属性'}),
        App.ServiceConfigCategory.create({ name: 'General', displayName: '一般'})
      ]);
      break;
    case 'STORM':
      serviceConfigCategories.pushObjects([
        ...
        App.ServiceConfigCategory.create({ name: 'STORM_UI_SERVER', displayName: 'Storm 界面', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'STORM_REST_API', displayName: 'Storm REST API 服务', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'DRPC_SERVER', displayName: 'DRPC 服务', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'General', displayName: '一般'})
      ]);
      break;
    case 'TEZ':
    ...
    case 'KNOX':
      serviceConfigCategories.pushObjects([
        App.ServiceConfigCategory.create({ name: 'KNOX_GATEWAY', displayName: 'Knox 网关', showHost: true})
      ]);
      break;
    case 'KAFKA':
      serviceConfigCategories.pushObjects([
    ...
    case 'RANGER':
      serviceConfigCategories.pushObjects([
        App.ServiceConfigCategory.create({ name: 'RANGER_ADMIN', displayName: '管理设置', showHost: true}),
        App.ServiceConfigCategory.create({ name: 'DBSettings', displayName: '数据库设置'}),
        App.ServiceConfigCategory.create({ name: 'RangerSettings', displayName: 'Ranger 设置'}),
        App.ServiceConfigCategory.create({ name: 'UnixAuthenticationSettings', displayName: 'Unix 认证设置'}),
        App.ServiceConfigCategory.create({ name: 'ADSettings', displayName: 'AD 设置'}),
        App.ServiceConfigCategory.create({ name: 'LDAPSettings', displayName: 'LDAP 设置'}),
  ...
  serviceConfigCategories.pushObject(App.ServiceConfigCategory.create({ name: 'Advanced', displayName: '高级'}));
