...
App.Router = Em.Router.extend({
   ...
   */
//  login_s: function () {
//    console.log('[DEBUG By ZQJ] ------------------------------------------------------------> login: method');
...
//    //取出第二个参数
//    var urlItem = paramArray[1];
//    //=再次划分
//    var item = urlItem.split("=");
//    //取出第二个参数是用户名
//     var username = item[1];
//    //取出第三个参数
//    var urlpassword = paramArray[2];
//    //=再次划分
//    var item2 = urlpassword.split("=");
//    //取出密码
//    var urlpwd = item2[1];
//    //去除#后的东西
//    var urlpwdt = urlpwd.split("#");
//
//    var urlmima = urlpwdt[0];
//
////用户名和密码
//   ;
//
...
//    //解压密码
//
//    var trpassword = misc.b64ToUtf8(urlmima);
//
//
//    //var loginName = 'admin'
...
//    var hash = misc.utf8ToB64(loginName + ":" + trpassword);
